...
if is_dark:
    ...
    bg_color = "#0e1117"
    text_color = "#ffffff"
    # CSS to force dark background for tables
...
selected_cohorts = st.sidebar.multiselect("Select Acquisition Cohorts:", 
                                         options=sorted(df_users['cohort'].unique()), 
                                         default=sorted(df_users['cohort'].unique()),
